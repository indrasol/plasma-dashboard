...
export const env: EnvConfig = {
  SUPABASE_URL: import.meta.env.VITE_SUPABASEURL_1 || import.meta.env.VITE_SUPABASE_URL_1 || '',
  SUPABASE_ANON_KEY: import.meta.env.VITE_SUPABASE_ANON_KEY || import.meta.env.VITE_SUPABASE_ANON_KEY_1 || '',
